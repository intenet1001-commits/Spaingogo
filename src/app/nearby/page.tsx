    ...
    <div className="pb-24">
      ...
      <header className="bg-gradient-to-br from-[#1A1209] to-[#2A1810] px-5 pt-14 pb-8 text-white">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h1 className="font-serif text-2xl font-bold">주변 맛집</h1>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-[#6B5E4E] dark:text-[#B8A898] font-medium">
              {radius / 1000 < 1 ? `${radius}m` : `${radius / 1000}km`} 내 맛집이 없습니다
            </p>
          ...
          <>
            <p className="text-xs text-[#8A7A6A] mb-4">
              반경 {radius >= 1000 ? `${radius / 1000}km` : `${radius}m`} 내 {nearby.length}개 맛집
            </p>
